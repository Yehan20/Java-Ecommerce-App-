 ...
 * 
 */
@WebServiceClient(name = "CustomerServices", targetNamespace = "http://techmartwebservices.mycompany.com/", wsdlLocation = "http://localhost:8080/TechMartWebServices/CustomerServices?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICES_QNAME = new QName("http://techmartwebservices.mycompany.com/", "CustomerServices");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/TechMartWebServices/CustomerServices?wsdl");
    ...
    public CustomerServices getCustomerServicesPort() {
        return super.getPort(new QName("http://techmartwebservices.mycompany.com/", "CustomerServicesPort"), CustomerServices.class);
    }
    ...
    public CustomerServices getCustomerServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://techmartwebservices.mycompany.com/", "CustomerServicesPort"), CustomerServices.class, features);
    }
